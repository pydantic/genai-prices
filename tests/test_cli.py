...
def test_calc(capsys: pytest.CaptureFixture[str]):
    ...
    assert out == snapshot("""\
      Provider: OpenAI
         Model: gpt 4o
  Model Prices: $2.5/input MTok, $10/output MTok, $1.25/input cache read MTok, $10/web searches K
...
def test_calc_timestamp(capsys: pytest.CaptureFixture[str]):
    ...
    assert out == snapshot("""\
      Provider: OpenAI
         Model: o3
  Model Prices: $2/input MTok, $8/output MTok, $0.5/input cache read MTok, $10/web searches K
...
""")
    ...
    assert out == snapshot("""\
      Provider: OpenAI
         Model: o3
  Model Prices: $10/input MTok, $40/output MTok, $0.5/input cache read MTok, $10/web searches K
Context Window: 200,000
   Input Price: $0.1
  Output Price: $0
   Total Price: $0.1
