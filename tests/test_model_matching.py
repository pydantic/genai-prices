...
test_cases: list[tuple[str, str, str]] = [
    ...
    pytest.param(
        ...
        snapshot(('aws', 'meta.llama4-maverick-17b-instruct-v1:0')),
    ),
    ...
    pytest.param('bedrock', 'us.meta.llama3-3-70b-instruct-v1:0', snapshot(('aws', 'meta.llama3-3-70b-instruct-v1:0'))),
    ...
    ('anthropic', 'claude-sonnet-4@20250514', snapshot(('anthropic', 'claude-sonnet-4-0'))),
    pytest.param('bedrock', 'amazon.nova-pro-v1:0', snapshot(('aws', 'amazon.nova-pro-v1:0'))),
    ...
    pytest.param('bedrock', 'us.amazon.nova-pro-v1:0', snapshot(('aws', 'amazon.nova-pro-v1:0'))),
    ...
    pytest.param('aws.bedrock', 'us.amazon.nova-micro-v1:0', snapshot(('aws', 'amazon.nova-micro-v1:0'))),
    ...
    pytest.param('bedrock', 'meta.llama3-70b-instruct-v1:0', snapshot(('aws', 'meta.llama3-70b-instruct-v1:0'))),
    pytest.param('bedrock', 'meta.llama3-2-90b-instruct-v1:0', snapshot(('aws', 'meta.llama3-2-90b-instruct-v1:0'))),
    ...
    ('openai', 'gpt-5-4-nano', snapshot(('openai', 'gpt-5.4-nano'))),
    ('openai', 'gpt-5-4-nano-2026-03-17', snapshot(('openai', 'gpt-5.4-nano'))),
    ('openai', 'gpt-5.6', snapshot(('openai', 'gpt-5.6-sol'))),
    ('openai', 'gpt-5-6', snapshot(('openai', 'gpt-5.6-sol'))),
    ('openai', 'gpt-5.6-sol', snapshot(('openai', 'gpt-5.6-sol'))),
    ('openai', 'gpt-5-6-sol', snapshot(('openai', 'gpt-5.6-sol'))),
    ('openai', 'gpt-5.6-terra', snapshot(('openai', 'gpt-5.6-terra'))),
    ('openai', 'gpt-5-6-terra', snapshot(('openai', 'gpt-5.6-terra'))),
    ('openai', 'gpt-5.6-luna', snapshot(('openai', 'gpt-5.6-luna'))),
    ('openai', 'gpt-5-6-luna', snapshot(('openai', 'gpt-5.6-luna'))),
