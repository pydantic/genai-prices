...
test_cases: list[tuple[str, str, str]] = [
    ...
    pytest.param('google-vertex', 'publishers/google/models/gemini-2.5-flash', None, marks=mark_xfail_todo),
    ...
    pytest.param('bedrock', 'us.anthropic.claude-sonnet-4-20250514-v1:0', None, marks=mark_xfail_todo),
    ...
    pytest.param('bedrock', 'us.anthropic.claude-3-7-sonnet-20250219-v1:0', None, marks=mark_xfail_todo),
    ...
    pytest.param('bedrock', 'us.anthropic.claude-3-5-haiku-20241022-v1:0', None, marks=mark_xfail_todo),
    ...
    pytest.param('bedrock', 'eu.anthropic.claude-sonnet-4-20250514-v1:0', None, marks=mark_xfail_todo),
    pytest.param('bedrock', 'us.meta.llama3-2-90b-instruct-v1:0', None, marks=mark_xfail_todo),
    ('openai', 'gpt-4o-2024-05-13', snapshot(('openai', 'gpt-4o'))),
    ('google-gla', 'gemini-1.5-flash', snapshot(('google', 'gemini-1.5-flash'))),
    (
        'groq',
        'moonshotai/kimi-k2-instruct',
        snapshot(('groq', 'moonshotai/kimi-k2-instruct')),
    ),
    ('anthropic', 'claude-opus-4-0', snapshot(('anthropic', 'claude-opus-4-0'))),
    ('anthropic', 'claude-sonnet-4@20250514', snapshot(('anthropic', 'claude-sonnet-4-0'))),
    pytest.param('bedrock', 'amazon.nova-pro-v1:0', None, marks=mark_xfail_todo),
    ('google-vertex', 'gemini-2.0-flash-001', snapshot(('google', 'gemini-2.0-flash'))),
    pytest.param('google-vertex', 'publishers/google/models/gemini-2.5-pro', None, marks=mark_xfail_todo),
    ('openai', 'gpt-4', snapshot(('openai', 'gpt-4'))),
    ('gemini', 'gemini-2.5-flash-lite', snapshot(('google', 'gemini-2.5-flash-lite'))),
    pytest.param('bedrock', 'amazon.nova-micro-v1:0', None, marks=mark_xfail_todo),
    ...
    ('groq', 'qwen/qwen3-32b', snapshot(('groq', 'qwen/qwen3-32b'))),
    ('gcp.vertex.agent', 'gemini-2.5-flash-preview-05-20', snapshot(('google', 'gemini-2.5-flash-preview'))),
    ('groq', 'llama-3.1-8b-instant', snapshot(('groq', 'llama-3.1-8b-instant'))),
    (
        'groq',
        'meta-llama/llama-4-scout-17b-16e-instruct',
        snapshot(('groq', 'meta-llama/llama-4-scout-17b-16e-instruct')),
    ),
    ...
    ('groq', 'deepseek-r1-distill-llama-70b', snapshot(('groq', 'deepseek-r1-distill-llama-70b'))),
    ...
    (
        ...
        snapshot(('groq', 'meta-llama/llama-4-maverick-17b-128e-instruct')),
    ),
    ...
    pytest.param('bedrock', 'us.anthropic.claude-3-5-sonnet-20240620-v1:0', None, marks=mark_xfail_todo),
    pytest.param('bedrock', 'meta.llama3-1-70b-instruct-v1:0', None, marks=mark_xfail_todo),
    ...
    pytest.param('bedrock', 'apac.anthropic.claude-3-5-sonnet-20241022-v2:0', None, marks=mark_xfail_todo),
    ('mistral_ai', 'mistral-large-2411', snapshot(('mistral', 'mistral-large'))),
    pytest.param('bedrock', 'us.amazon.nova-pro-v1:0', None, marks=mark_xfail_todo),
    ('anthropic', 'claude-3-opus', snapshot(('anthropic', 'claude-3-opus-latest'))),
    pytest.param('bedrock', 'eu.anthropic.claude-3-7-sonnet-20250219-v1:0', None, marks=mark_xfail_todo),
    ...
    pytest.param('bedrock', 'us.anthropic.claude-3-5-sonnet-20241022-v2:0', None, marks=mark_xfail_todo),
    ...
    pytest.param('nebius', 'llama-3.3-70b-versatile', None, marks=mark_xfail_todo),
    ...
    pytest.param('bedrock', 'us.amazon.nova-lite-v1:0', None, marks=mark_xfail_todo),
    ...
    pytest.param('nebius', 'Qwen/Qwen3-32B', None, marks=mark_xfail_todo),
    ('gemini', 'models/gemini-2.5-flash-preview-05-20', snapshot(('google', 'gemini-2.5-flash-preview'))),
    pytest.param('bedrock', 'anthropic.claude-sonnet-4-20250514-v1:0', None, marks=mark_xfail_todo),
    ...
    pytest.param('huggingface', 'moonshotai/Kimi-K2-Instruct', None, marks=mark_xfail_todo),
    ...
    pytest.param('bedrock', 'meta.llama3-70b-instruct-v1:0', None, marks=mark_xfail_todo),
    pytest.param('bedrock', 'meta.llama3-2-90b-instruct-v1:0', None, marks=mark_xfail_todo),
    ...
    pytest.param('openrouter', 'qwen/qwen3-coder', None, marks=mark_xfail_todo),
    pytest.param('bedrock', 'us.meta.llama4-maverick-17b-instruct-v1', None, marks=mark_xfail_todo),
    ...
    pytest.param('deepinfra', 'zai-org/GLM-4.5', None, marks=mark_xfail_todo),
    pytest.param('deepinfra', 'Qwen/Qwen3-235B-A22B', None, marks=mark_xfail_todo),
    pytest.param('openrouter', 'deepseek/deepseek-r1-0528', None, marks=mark_xfail_todo),
    pytest.param('huggingface', 'moonshotai/kimi-k2-instruct', None, marks=mark_xfail_todo),
...
def test_azure_fallback_to_openai_real_data():
    ...
    update the test to use a different OpenAI-exclusive model.
    """
    azure = find_provider_by_id(providers, 'azure')
