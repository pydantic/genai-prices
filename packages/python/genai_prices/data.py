...
providers: list[Provider] = [
    ...
    Provider(
        ...
        pricing_urls=['https://huggingface.co/docs/inference-providers/en/index'],
        provider_match=ClauseEquals(equals='huggingface'),
        extractors=[
            UsageExtractor(
                root='usage',
                mappings=[
