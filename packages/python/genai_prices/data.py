    ...
    Provider(
        ...
        models=[
            ...
            ModelInfo(
                ...
                context_window=1050000,
                price_comments='Cache writes are billed at 1.25x the uncached input rate. Long-context tier (>272K input tokens) is 2x input and 1.5x output. OpenAI reduced Luna prices by 80% on 2026-07-30. Refs: https://developers.openai.com/api/docs/pricing, https://developers.openai.com/api/docs/changelog',
                prices=[
                    ConditionalPrice(
                        prices=ModelPrice(
            ...
            ModelInfo(
                ...
                context_window=1050000,
                price_comments='Cache writes are billed at 1.25x the uncached input rate. Long-context tier (>272K input tokens) is 2x input and 1.5x output. Ref: https://developers.openai.com/api/docs/models/gpt-5.6-terra',
                prices=ModelPrice(
