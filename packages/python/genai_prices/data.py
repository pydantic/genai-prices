        ...
        models=[
            ...
            ModelInfo(
                ...
                prices=ModelPrice(
                    input_mtok=Decimal('3'),
                    cache_write_mtok=Decimal('3.75'),
                    cache_write_5m_mtok=Decimal('3.75'),
            ...
            ModelInfo(
                ...
                prices=ModelPrice(
                    ...
                    cache_write_5m_mtok=Decimal('0.3'),
            ...
            ModelInfo(
                ...
                prices=ModelPrice(
                    ...
                    cache_write_5m_mtok=Decimal('18.75'),
            ...
            ModelInfo(
                ...
                prices=ModelPrice(
                    ...
                    cache_write_5m_mtok=Decimal('1.25'),
                ...
                prices=[
                    ConditionalPrice(
                        prices=ModelPrice(
                            ...
                            cache_write_5m_mtok=TieredPrices(
                                base=Decimal('6.25'), tiers=[Tier(start=200000, price=Decimal('12.5'))]
                            ),
        ...
        models=[
            ...
            ModelInfo(
                ...
                prices=ModelPrice(
                    ...
                    cache_write_5m_mtok=None,
                    cache_write_1h_mtok=None,
                    cache_read_mtok=Decimal('0.00875'),
            ...
            ModelInfo(
                ...
                prices=ModelPrice(input_mtok=Decimal('0.1'), cache_write_5m_mtok=None, cache_write_1h_mtok=None),
            ),
            ModelInfo(
            ...
            ModelInfo(
                ...
                name='DeepSeek-R1',
                prices=ModelPrice(
                    input_mtok=Decimal('1.35'),
                    cache_write_5m_mtok=None,
                    cache_write_1h_mtok=None,
                    output_mtok=Decimal('5.4'),
                ),
            ),
            ModelInfo(
            ...
            ModelInfo(
                ...
                prices=ModelPrice(
                    input_mtok=Decimal('0.16'),
                    cache_write_5m_mtok=None,
                    cache_write_1h_mtok=None,
                    output_mtok=Decimal('0.16'),
                ),
            ),
            ModelInfo(
    ...
    Provider(
        ...
        models=[
            ...
            ModelInfo(
                ...
                prices=ModelPrice(input_mtok=Decimal('0.4'), cache_write_5m_mtok=None, cache_write_1h_mtok=None),
            ),
            ModelInfo(
                id='curie',
                match=ClauseOr(
                ...
                prices=ModelPrice(input_mtok=Decimal('2'), cache_write_5m_mtok=None, cache_write_1h_mtok=None),
            ),
            ModelInfo(
                id='davinci',
                match=ClauseOr(
            ...
            ModelInfo(
                ...
                prices=ModelPrice(cache_write_5m_mtok=None, cache_write_1h_mtok=None),
            ),
            ModelInfo(
                id='o1',
                match=ClauseOr(
            ...
            ModelInfo(
                ...
                prices=ModelPrice(input_mtok=Decimal('0.13'), cache_write_5m_mtok=None, cache_write_1h_mtok=None),
            ),
            ModelInfo(
                id='text-embedding-3-small',
                match=ClauseEquals(equals='text-embedding-3-small'),
                prices=ModelPrice(input_mtok=Decimal('0.02'), cache_write_5m_mtok=None, cache_write_1h_mtok=None),
            ),
            ModelInfo(
                id='wizardlm-2-8x22b',
    ...
    Provider(
        ...
        models=[
            ...
            ModelInfo(
                ...
                context_window=128000,
                prices=ModelPrice(input_mtok=Decimal('0.12'), cache_write_5m_mtok=None, cache_write_1h_mtok=None),
            ),
        ],
    ),
    Provider(
    ...
    Provider(
        ...
        models=[
            ...
            ModelInfo(
                ...
                prices=ModelPrice(
                    input_mtok=Decimal('0.56'),
                    cache_write_5m_mtok=None,
                    cache_write_1h_mtok=None,
                    cache_read_mtok=Decimal('0.28'),
                    output_mtok=Decimal('1.68'),
                ),
            ),
            ModelInfo(
                id='gemma-3-27b-it',
    ...
    Provider(
        ...
        models=[
            ...
            ModelInfo(
                ...
                prices=ModelPrice(input_mtok=Decimal('0.15'), cache_write_5m_mtok=None, cache_write_1h_mtok=None),
            ),
            ModelInfo(
                id='gemini-flash-1.5',
    ...
    Provider(
        ...
        models=[
            ModelInfo(
                ...
                context_window=1000000,
                prices=ModelPrice(
                    input_mtok=Decimal('0.44'),
                    cache_write_5m_mtok=None,
                    cache_write_1h_mtok=None,
                    output_mtok=Decimal('1.76'),
                ),
            ),
            ModelInfo(
            ...
            ModelInfo(
                ...
                context_window=32000,
                prices=ModelPrice(
                    input_mtok=Decimal('0.304'),
                    cache_write_5m_mtok=None,
                    cache_write_1h_mtok=None,
                    output_mtok=Decimal('0.32'),
                ),
            ),
            ModelInfo(
                id='Qwen/Qwen3-235B-A22B',
            ...
            ModelInfo(
                ...
                context_window=131072,
                prices=ModelPrice(
                    input_mtok=Decimal('0.072'),
                    cache_write_5m_mtok=None,
                    cache_write_1h_mtok=None,
                    output_mtok=Decimal('0.464'),
                ),
            ),
            ModelInfo(
                id='Qwen/Qwen3-235B-A22B-Thinking-2507',
            ...
            ModelInfo(
                ...
                context_window=131072,
                prices=ModelPrice(
                    input_mtok=Decimal('0.784'),
                    cache_write_5m_mtok=None,
                    cache_write_1h_mtok=None,
                    output_mtok=Decimal('3.16'),
                ),
            ),
            ModelInfo(
            ...
            ModelInfo(
                ...
                context_window=262144,
                prices=ModelPrice(
                    input_mtok=Decimal('0.098'),
                    cache_write_5m_mtok=None,
                    cache_write_1h_mtok=None,
                    output_mtok=Decimal('0.293'),
                ),
            ),
            ModelInfo(
                ...
                prices=ModelPrice(
                    input_mtok=Decimal('0.496'),
                    cache_write_5m_mtok=None,
                    cache_write_1h_mtok=None,
                    output_mtok=Decimal('0.496'),
                ),
            ),
            ModelInfo(
            ...
            ModelInfo(
                ...
                context_window=128000,
                prices=ModelPrice(
                    input_mtok=Decimal('0.048'),
                    cache_write_5m_mtok=None,
                    cache_write_1h_mtok=None,
                    output_mtok=Decimal('0.072'),
                ),
            ),
            ModelInfo(
            ...
            ModelInfo(
                ...
                context_window=163840,
                prices=ModelPrice(
                    input_mtok=Decimal('0.216'),
                    cache_write_5m_mtok=None,
                    cache_write_1h_mtok=None,
                    output_mtok=Decimal('0.896'),
                ),
            ),
            ModelInfo(
            ...
            ModelInfo(
                ...
                context_window=8192,
                prices=ModelPrice(
                    input_mtok=Decimal('0.032'),
                    cache_write_5m_mtok=None,
                    cache_write_1h_mtok=None,
                    output_mtok=Decimal('0.032'),
                ),
            ),
            ModelInfo(
                id='moonshotai/Kimi-K2-Instruct',
                ...
                context_window=131072,
                prices=ModelPrice(
                    input_mtok=Decimal('0.456'),
                    cache_write_5m_mtok=None,
                    cache_write_1h_mtok=None,
                    output_mtok=Decimal('1.84'),
                ),
            ),
            ModelInfo(
                id='moonshotai/Kimi-K2-Thinking',
            ...
            ModelInfo(
                ...
                context_window=131072,
                prices=ModelPrice(
                    input_mtok=Decimal('0.104'),
                    cache_write_5m_mtok=None,
                    cache_write_1h_mtok=None,
                    output_mtok=Decimal('0.68'),
                ),
            ),
            ModelInfo(
                id='zai-org/GLM-4.5V',
    ...
    Provider(
        ...
        models=[
            ModelInfo(
                ...
                context_window=32768,
                prices=ModelPrice(
                    input_mtok=Decimal('1.01'),
                    cache_write_5m_mtok=None,
                    cache_write_1h_mtok=None,
                    output_mtok=Decimal('1.01'),
                ),
            ),
            ModelInfo(
                id='Qwen/Qwen3-32B',
    ...
    Provider(
        ...
        models=[
            ...
            ModelInfo(
                ...
                context_window=4096,
                prices=ModelPrice(
                    input_mtok=Decimal('0.18000000000000002'),
                    cache_write_5m_mtok=None,
                    cache_write_1h_mtok=None,
                    output_mtok=Decimal('0.18000000000000002'),
                ),
            ),
            ModelInfo(
                id='meta-llama/Llama-3.2-3B-Instruct',
                ...
                context_window=131072,
                prices=ModelPrice(
                    input_mtok=Decimal('0.060000000000000005'),
                    cache_write_5m_mtok=None,
                    cache_write_1h_mtok=None,
                    output_mtok=Decimal('0.060000000000000005'),
                ),
            ),
            ModelInfo(
                id='meta-llama/Llama-3.3-70B-Instruct',
    ...
    Provider(
        ...
        models=[
            ...
            ModelInfo(
                ...
                context_window=32768,
                prices=ModelPrice(
                    input_mtok=Decimal('0.96'),
                    cache_write_5m_mtok=None,
                    cache_write_1h_mtok=None,
                    output_mtok=Decimal('0.96'),
                ),
            ),
            ModelInfo(
                id='Qwen2.5-VL-72B-Instruct',
            ...
            ModelInfo(
                ...
                context_window=512,
                prices=ModelPrice(input_mtok=Decimal('0.01'), cache_write_5m_mtok=None, cache_write_1h_mtok=None),
            ),
            ModelInfo(
                id='bge-m3',
