    ...
    Provider(
        ...
        models=[
            ...
            ModelInfo(
                ...
                name='DeepSeek-V4-Flash',
                prices=ModelPrice(
                    input_mtok=Decimal('0.14'), cache_read_mtok=Decimal('0.03'), output_mtok=Decimal('0.28')
                ),
            ),
            ModelInfo(
                id='deepseek-v4-pro',
                ...
                name='DeepSeek-V4-Pro',
                prices=ModelPrice(
                    input_mtok=Decimal('1.74'), cache_read_mtok=Decimal('0.14'), output_mtok=Decimal('3.48')
                ),
            ),
            ModelInfo(
                id='gemma-3-27b-it',
