  ...
  },
  {
    ...
    models: [
      ...
      },
      {
        ...
        match: {
          or: [
            ...
            {
              equals: 'gemini-3.5-flash-latest',
            },
            {
      ...
      },
      {
        ...
        description:
          "Google's fastest and most cost-efficient Gemini 3.5 series model, built for intelligence at scale. Optimized for high-volume, low-latency applications while maintaining strong multimodal capabilities.",
        match: {
