...
OpenAI long-context boundary and xAI's top-level realtime `usage` extraction. Phase 2 adds wire decoding, registry
evolution validation, active-registry switching, and v3 publication around those engines.
