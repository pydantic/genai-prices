...
**Phase 1 publishes full and slim provider-array v2 data.** _(from "V1 remains an exact frozen compatibility snapshot", "Pricing accuracy is the Phase 1 product outcome")_
...
**Tests prove the complete releasable contract.** _(from "Phase 1 must be independently shippable and releasable", "V1 remains an exact frozen compatibility snapshot")_
