...
Even though Phase 2 still consumes provider-array remote data, the active JavaScript registry and active provider data must not drift apart during startup or local staging. Failed parsing or validation leaves the current active state unchanged.
