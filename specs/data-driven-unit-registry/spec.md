...
**`input_price` and `output_price` are backward-compat accessors over direction-filtered costs.** _(from "Decomposition uses dimensions", "Backward compatibility")_
